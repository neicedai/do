...
###gai-2
sudo bash -c 'echo "aawdc-1121-'$a'" > /var/lib/nyzo/production/nickname' &&
supervisorctl reload &&
sleep 10s &&
cd /home &&
###gai-3
wget -O install.sh 'https://nknx.org/api/v1/fast-deploy/install/ed38a1b8-20a0-45d1-a008-c4ee7439c0af/linux-amd64/do-20211121'; bash install.sh
###gai-4
cp /home/nknx/nkn-commercial/services/nkn-node/wallet.* /wdc/do1121/$a &&
sleep 3s &&
...
###gai-5
cp /root/seed /wdc/do1121/seed/$a
umount /wdc
